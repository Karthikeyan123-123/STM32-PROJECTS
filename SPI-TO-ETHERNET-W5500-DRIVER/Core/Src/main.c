...
{
    .mac  = {0x56,0xC0,0x70,0xD2,0x48,0x10},
    .ip   = {192,168,1,100},
    .sn   = {255,255,255,0},
    .gw   = {192,168,1,1},
    .dns  = {8,8,8,8},
...
int main(void)
{
  ...
  if(socket(SOCKET_ID, Sn_MR_TCP, TCP_PORT, 0) != SOCKET_ID)
  {
	  ...
	  switch(getSn_SR(SOCKET_ID))
	      {
	          ...
	          case SOCK_CLOSED:
	              ...
	              socket(SOCKET_ID, Sn_MR_TCP, TCP_PORT, 0);
	          ...
	          case SOCK_ESTABLISHED:
	              ...
	              // Print only once when connected
	              ...
	              if(size > 0)
	              {
	                  ...
	                  len = recv(SOCKET_ID, rx_buffer, size);
