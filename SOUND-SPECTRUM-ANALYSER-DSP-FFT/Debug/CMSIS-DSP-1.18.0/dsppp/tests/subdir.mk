...
C_SRCS += \
../CMSIS-DSP-1.18.0/dsppp/tests/bench.c 

OBJS += \
./CMSIS-DSP-1.18.0/dsppp/tests/bench.o 

C_DEPS += \
./CMSIS-DSP-1.18.0/dsppp/tests/bench.d 


# Each subdirectory must supply rules for building sources it contributes
CMSIS-DSP-1.18.0/dsppp/tests/%.o CMSIS-DSP-1.18.0/dsppp/tests/%.su CMSIS-DSP-1.18.0/dsppp/tests/%.cyclo: ../CMSIS-DSP-1.18.0/dsppp/tests/%.c CMSIS-DSP-1.18.0/dsppp/tests/subdir.mk
...
clean: clean-CMSIS-2d-DSP-2d-1-2e-18-2e-0-2f-dsppp-2f-tests

clean-CMSIS-2d-DSP-2d-1-2e-18-2e-0-2f-dsppp-2f-tests:
	-$(RM) ./CMSIS-DSP-1.18.0/dsppp/tests/bench.cyclo ./CMSIS-DSP-1.18.0/dsppp/tests/bench.d ./CMSIS-DSP-1.18.0/dsppp/tests/bench.o ./CMSIS-DSP-1.18.0/dsppp/tests/bench.su

.PHONY: clean-CMSIS-2d-DSP-2d-1-2e-18-2e-0-2f-dsppp-2f-tests
