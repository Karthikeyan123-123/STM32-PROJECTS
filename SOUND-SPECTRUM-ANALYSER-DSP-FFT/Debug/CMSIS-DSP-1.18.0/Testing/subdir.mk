...
C_SRCS += \
../CMSIS-DSP-1.18.0/Testing/patterndata.c 

OBJS += \
./CMSIS-DSP-1.18.0/Testing/patterndata.o 

C_DEPS += \
./CMSIS-DSP-1.18.0/Testing/patterndata.d 


# Each subdirectory must supply rules for building sources it contributes
CMSIS-DSP-1.18.0/Testing/%.o CMSIS-DSP-1.18.0/Testing/%.su CMSIS-DSP-1.18.0/Testing/%.cyclo: ../CMSIS-DSP-1.18.0/Testing/%.c CMSIS-DSP-1.18.0/Testing/subdir.mk
...
clean: clean-CMSIS-2d-DSP-2d-1-2e-18-2e-0-2f-Testing

clean-CMSIS-2d-DSP-2d-1-2e-18-2e-0-2f-Testing:
	-$(RM) ./CMSIS-DSP-1.18.0/Testing/patterndata.cyclo ./CMSIS-DSP-1.18.0/Testing/patterndata.d ./CMSIS-DSP-1.18.0/Testing/patterndata.o ./CMSIS-DSP-1.18.0/Testing/patterndata.su

.PHONY: clean-CMSIS-2d-DSP-2d-1-2e-18-2e-0-2f-Testing
